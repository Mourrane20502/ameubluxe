...
const canapes = products.filter((p) => p.category === "fauteuille");

export default function FeautaillePage() {
  return (
    <div className="relative  min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="mb-6 text-sm text-gray-500">
          ...
          <span className="text-[#dbb350] font-semibold">Fauteuille</span>
        </div>

        <h1 className="text-4xl font-bold mb-10 text-[#dbb350]">Fauteuille</h1>
